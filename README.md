# Installation  NEW release Erigon [v3.0.2](https://github.com/erigontech/erigon/releases/tag/v3.0.2) + lighthouse [v6.0.1](https://github.com/sigp/lighthouse/tree/v6.0.1) or quick update
